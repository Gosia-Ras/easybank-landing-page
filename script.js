let socials = [
  ...
  {
    name: "Youtube",
    icon: ` <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
        <path
          fill="#FFF"
  ...
  {
    name: "Twitter",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="21" height="18">
        <path
          fill="#FFF"
...
let socialsContainer = document.querySelector(".socials");

socials.forEach((social) => {
  let socialLink = document.createElement("li");
  socialLink.innerHTML = `<a aria-label="${social.name}" href="${social.href}">${social.icon}</a>`;
  socialsContainer.append(socialLink);
});
